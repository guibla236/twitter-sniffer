...
class TwitterDataBase:
    ...
    def baseCreator(self,newFileName=None,cols=None):
        ...
        self.tableCreator(self.getTableName())
    ...
    def tableCreator(self,tableName):
        ...
        self.getCursor().execute("CREATE TABLE IF NOT EXISTS "+self.getTableName()+"("+self.getColsNames()+")")
    ...
    def insertData(self,cols):
        ...
        cols=["None" if i is None else i for i in cols] #Transform None element in String to join.
        data=tuple(cols)

        self.getCursor().execute("INSERT INTO {} VALUES {};".format(self.getTableName(),data))
